...
public class ReportProdotto {
	...
	public ReportProdotto(){
		
	}
	
	public ReportProdotto(int id, int quantità, String marca, String modello, String descrizione, String categoria,
	...
	public String toString() {
		return "ReportProdotto [id=" + id + ", quantità=" + quantità + ", marca=" + marca + ", modello=" + modello
