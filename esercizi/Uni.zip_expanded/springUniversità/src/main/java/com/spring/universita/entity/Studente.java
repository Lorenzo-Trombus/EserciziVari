...
public class Studente {
	...
	public Studente(int matricola, int annoNascita, int annoImmatricolazione, String nome, String cognome,
			String indirizzo) {
		super();
	...
	public String toString() {
		return "Studente [matricola=" + matricola + ", annoNascita=" + annoNascita + ", annoImmatricolazione="
