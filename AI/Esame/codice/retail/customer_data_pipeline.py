...
class DataPipeline:
    ...
    def process_data(self, df: pd.DataFrame) -> pd.DataFrame:
        df.rename(columns={'CustomerID': "CodiceCliente"},inplace=True)
        df.rename(columns={'Country': "Paese"},inplace=True)
        df.rename(columns={'StockCode': 'CodiceStock'},inplace=True)
        df.rename(columns={'Description':'Descrizione'},inplace=True)
